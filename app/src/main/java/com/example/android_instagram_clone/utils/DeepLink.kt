...
object DeepLink {
    ...
    fun createLongLink(partnerId: String) {
        val dynamicLink = Firebase.dynamicLinks.dynamicLink {
            link = Uri.parse("https://online.pdp.uz/course-play/mvvm-mvi")
            domainUriPrefix = "https://instagramdemo.page.link"
            // Open links with this app on Android
            androidParameters("com.example.android_instagram_clone") {
                minimumVersion = 100
            }
    ...
    fun createShortLink(partnerId: String) {
        Firebase.dynamicLinks.shortLinkAsync {
            link = Uri.parse("https://online.pdp.uz/course-play/mvvm-mvi")
            domainUriPrefix = "https://instagramdemo.page.linkhttps://instagramdemo.page.link"
            // Open links with this app on Android
            androidParameters("com.example.android_instagram_clone") {
                minimumVersion = 100
            }
